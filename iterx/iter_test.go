...
func ExampleFilter() {
	...
	for v := range viterx.Filter(context.Background(), numbers, func(n int) bool {
		return n > 2
	}) {
		fmt.Println(v)
	}
...
func ExampleMap() {
	...
	for v := range viterx.Map(context.Background(), numbers, func(n int) int {
		return n * 10
	}) {
		fmt.Println(v)
	}
...
func ExampleTake() {
	...
	for v := range viterx.Take(context.Background(), numbers, 3) {
		fmt.Println(v)
	}
	// Output:
	// 1
...
func ExampleFlatMap() {
	...
	for v := range viterx.FlatMap(context.Background(), numbers, func(n int) iter.Seq[int] {
		return slices.Values([]int{n, n * 10})
	}) {
		fmt.Println(v)
	}
...
func ExampleTakeWhile() {
	...
	for v := range viterx.TakeWhile(context.Background(), numbers, func(n int) bool {
		return n > 0
	}) {
		fmt.Println(v)
	}
...
func ExampleZip() {
	...
	for pair := range viterx.Zip(context.Background(), left, right) {
...
func ExampleChunk() {
	...
	for batch := range viterx.Chunk(context.Background(), numbers, 2) {
		fmt.Println(batch)
	}
	// Output:
	// [1 2]
...
func ExampleFlatten() {
	...
	for v := range viterx.Flatten(context.Background(), groups) {
		fmt.Println(v)
	}
	// Output:
	// 1
...
func ExampleDistinct() {
	...
	for v := range viterx.Distinct(context.Background(), numbers) {
		fmt.Println(v)
	}
	// Output:
	// 1
...
func ExampleContains() {
	...
	fmt.Println(viterx.Contains(context.Background(), numbers, 3))
	// Output:
	// true
}
...
func ExampleForEach() {
	...
	viterx.ForEach(context.Background(), numbers, func(v int) {
		fmt.Println(v * 2)
	})
	// Output:
	// 2
...
func ExampleReverse() {
	...
	for v := range viterx.Reverse(context.Background(), numbers) {
		fmt.Println(v)
	}
	// Output:
	// 5
...
func ExampleDrain() {
	...
	_ = viterx.Drain(context.Background(), numbers, func(n int) error {
		fmt.Println(n)
		return nil
	})
	// Output:
